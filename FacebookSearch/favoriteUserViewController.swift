...
class favoriteUserViewController: UIViewController,  UITableViewDataSource, UITableViewDelegate{
    ...
    let typeString = "userFavoriteData"
    let cellType = "userFavoriteCell"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellType, for: indexPath) as! FaUserTableViewCell
