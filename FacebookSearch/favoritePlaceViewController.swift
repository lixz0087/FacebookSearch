...
class favoritePlaceViewController: UIViewController,  UITableViewDataSource, UITableViewDelegate{
    ...
    let favoriteTypeString = "favoritePlace"
    let typeString = "placeFavoriteData"
    let cellType = "placeFavoriteCell"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellType, for: indexPath) as! FaPlaceTableViewCell
