...
class favoriteGroupViewController: UIViewController,  UITableViewDataSource, UITableViewDelegate{
    ...
    let favoriteTypeString = "favoriteGroup"
    let typeString = "groupFavoriteData"
    let cellType = "groupFavoriteCell"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellType, for: indexPath) as! FaGroupTableViewCell
