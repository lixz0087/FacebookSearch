...
class favoriteEventViewController: UIViewController,  UITableViewDataSource, UITableViewDelegate{
    ...
    let typeString = "eventFavoriteData"
    let cellType = "eventFavoriteCell"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellType, for: indexPath) as! FaEventTableViewCell
